...
public class LogEnhance {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileInputFormat.setInputPaths(job, new Path("C:\\hadoop\\webLog\\in"));

        // 尽管我们用的是自定义outputformat，但是它是继承制fileoutputformat
        // 在fileoutputformat中，必须输出一个_success文件，所以在此还需要设置输出path
        FileOutputFormat.setOutputPath(job, new Path("C:\\hadoop\\webLog\\out"));
    ...
    private static class LogEnhanceMapper extends Mapper<LongWritable, Text, Text, NullWritable> {
