...
public class RJoin {
    ...
    public static void main(String[] args) throws Exception {
        if (args == null || args.length == 0) {
            args = new String[2];
            args[0] = "file:/C:/hadoop/RJoin/in";
            args[1] = "file:/C:/hadoop/RJoin/out";
        }
    ...
    private static class RJoinMapper extends Mapper<LongWritable, Text, Text, InfoBean> {
    ...
    private static class RJoinReducer extends Reducer<Text, InfoBean, InfoBean, NullWritable> {
