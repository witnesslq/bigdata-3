package com.myhadoop.mr.sharefriend;
...
public class SharedFriendsStepTwo {
    public static void main(String[] args) throws Exception {
        ...
        FileInputFormat.setInputPaths(job, new Path("C:\\hadoop\\friends\\in2"));
        FileOutputFormat.setOutputPath(job, new Path("C:\\hadoop\\friends\\out2"));
