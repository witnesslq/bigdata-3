...
//		conf.set("fs.defaultFS", "hdfs://mini1:9000");
        ...
        //可以直接传入 uri和用户身份
        fs = FileSystem.get(new URI("file:///"), conf, "hadoop");
    }
    ...
    public void testDownload() throws Exception {
        ...
        fs.copyToLocalFile(new Path("/access.log.copy"), new Path("C:/"));
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        fs.copyFromLocalFile(new Path("c:/access.log"), new Path("c:/access.log.copy"));
        fs.close();
    }
